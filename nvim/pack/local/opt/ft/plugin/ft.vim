...
call ft#add('*.{cpp,hpp}', 'cpp', 'octol/vim-cpp-enhanced-highlight', '//\ %s')
call ft#add('*.{c,h}', 'c', 'octol/vim-cpp-enhanced-highlight', '//\ %s')
