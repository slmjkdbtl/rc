...
syn match  iniLabel    "^.\{-}\ze\s*=" nextgroup=iniNumber,iniValue
syn match  iniValue    "=\zs.*"
syn match  iniNumber   "=\zs\s*\d\+\s*$"
syn match  iniNumber   "=\zs\s*\d*\.\d\+\s*$"
syn match  iniNumber   "=\zs\s*\d\+e[+-]\=\d\+\s*$"
...
hi def link iniNumber   Number
hi def link iniHeader   Special
