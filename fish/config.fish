...
alias disk "df -h ."
alias sudo "sudo -E"
set ytdlparg "--external-downloader aria2c --external-downloader-args '-x 16 -s 16 -k 1M' --cookies ~/files/cookies.txt"
alias ydl "yt-dlp --format mp4 -o '%(title)s.%(ext)s' -i --no-playlist $ytdlparg"
alias ydll "yt-dlp --format mp4 -o '%(title)s.%(ext)s' -i --yes-playlist $ytdlparg"
